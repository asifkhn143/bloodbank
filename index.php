   ...
   <?php require 'message.php'; ?>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <i class="fa fa-envelope"> </i> <a href="mailto:bloodbank@gmail.com"> bloodbank@gmail.com</a><br><br>
                        <i class="fa fa-mobile"> </i> <a href="tel:+919876543210"> +91 9876543210</a><br><br>
                    </div>
                </div>
            </div>
            </div>
        ...
        <div class="row">
            ...
            <video width="100%" height="100%" controls>
                ...
                <source src="video/bd.ogg" type="video/ogg">
                Your browser does not support the video tag.
            </video>
            </div>
            <div class="col-lg-6 rounded mb-5">
                <iframe width="100%" height="100%" src="https://www.youtube.com/embed/cKnEdvrmHK4" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
